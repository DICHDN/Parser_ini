...
* Если искомого значения переменной нет, нужно вывести подсказку для пользователя — названия других переменных из этой секции. Возможно, пользователь опечатался.
 ...
 # Реализовано:
 * меню работы пользователя через командную строку (выводит информацию о разделах и переменных с значениями)
 * сохранение исходного файла с расширение .bac
 * сохранение файла с удалением лишних пробелов, и коментариев, а так же изменений если такивые были.
 * пример вызова parser.get_value с вариантами возможных ошибок.